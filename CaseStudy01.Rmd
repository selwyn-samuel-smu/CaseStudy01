...
#
# 2. Add State Name to the data frame. The one with NA is Wahington DC
#
...
One of the first tasks for the team is to analyze the distribution of Breweries across various states in the US. The data contained information about all 50 states and also Washington DC. 

```{r}

#
# We use the table function to let R do most of the work for us.
# We coerce the result to a dataframe so that we can get a prettier print by state.
#
