...
barplot(ibu.table$IBU[28:51] , border=F , names.arg=ibu.table$StateName[28:51], las=2, ylim=c(0,65), xlim=c(0, 40), width=1.5, main="Median IBU by State", col="green", ylab="IBU")
...
barplot(abvp.table$ABV[28:51] , border=F , names.arg=ibu.table$StateName[28:51], las=2, ylim=c(0,0.07), xlim=c(0, 40), width=1.5, main="Median ABV% by State", col="blue", ylab="ABV %")
```
